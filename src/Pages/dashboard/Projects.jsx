...
const Modal = ({ title, onClose, children }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
    ...
    >
      <div className="absolute -inset-0.5 bg-gradient-to-r from-red-600 to-orange-500 rounded-2xl blur opacity-20 pointer-events-none" />
...
const ProjectForm = ({
  ...
  const [form, setForm] = useState({
    ...
    TechStack: Array.isArray(initial?.tech_stack || initial?.TechStack)
      ? (initial.tech_stack || initial.TechStack).join(", ")
    ...
    >
      ...
      <div className="flex justify-end gap-2 pt-1">
        ...
        <button type="submit" disabled={uploading} className="relative group/s">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-red-600 to-orange-500 rounded-xl opacity-60 blur group-hover/s:opacity-100 transition duration-300" />
          <div className="relative flex items-center gap-2 px-5 py-2 bg-[#020202] rounded-xl border border-white/10">
            {uploading ? (
  ...
  return (
    <div className="space-y-6z ">
      ...
      <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
        ...
        >
          <div className="absolute -inset-0.5 bg-gradient-to-r from-red-600 to-orange-500 rounded-xl opacity-50 blur group-hover:opacity-80 transition duration-300" />
          <div className="relative flex items-center gap-2 px-4 py-2.5 bg-[#020202] rounded-xl border border-white/10">
