...
const socialLinks = [
  ...
  },
  {
    ...
    subText: "@ndm.dox",
    icon: Instagram,
    url: "https://www.instagram.com/ndm.dox?igsh=MXRxdW52YzI0ZWk0dg==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "nehemia17@gmail.com",
    icon: Mail,
    url: "mailto:nehemia17@gmail.com",
    color: "#D14836",
    gradient: "from-[#D14836] to-[#c53929]",
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Nehemia17",
    icon: Github,
    url: "https://github.com/Nehemia17",
    color: "#ffffff",
    ...
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, email].map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
