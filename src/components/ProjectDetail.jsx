...
const TechBadge = ({ tech }) => {
  ...
  return (
    <div className="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-gradient-to-r from-red-600/10 to-orange-500/10 rounded-xl border border-red-500/10 hover:border-red-500/30 transition-all duration-300 cursor-default">
      <div className="absolute inset-0 bg-gradient-to-r from-red-500/0 to-orange-500/0 group-hover:from-red-500/10 group-hover:to-orange-500/10 transition-all duration-500" />
  ...
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
      <div className="relative mt-2">
        <div className="absolute -inset-1 bg-gradient-to-r from-red-600/20 to-orange-500/20 rounded-full blur group-hover:opacity-100 opacity-0 transition-opacity duration-300" />
        <div className="relative w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-gradient-to-r from-red-400 to-orange-400 group-hover:scale-125 transition-transform duration-300" />
      </div>
...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#0a0a1a] rounded-xl overflow-hidden relative">
      <div className="absolute inset-0 bg-gradient-to-br from-red-900/20 to-orange-900/20 opacity-50 blur-2xl z-0" />
...
const ProjectDetails = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{project.title} — Nehemia Dheadema Mareten</title>
        <meta
          name="description"
          content={
            project.description
              ? project.description.slice(0, 155)
              : `Project ${project.title} oleh Nehemia Dheadema Mareten — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.title} — Nehemia Dheadema Mareten`}
        />
        <meta
      ...
      <div className="min-h-screen bg-[#020202] px-[2%] sm:px-0 relative overflow-hidden">
        <div className="fixed inset-0">
          <div className="absolute -inset-[10px] opacity-20">
            <div className="absolute top-0 -left-4 w-72 md:w-96 h-72 md:h-96 bg-red-500 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob" />
            <div className="absolute top-0 -right-4 w-72 md:w-96 h-72 md:h-96 bg-orange-500 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000" />
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
              <div className="space-y-6 md:space-y-10 animate-slideInLeft">
                <div className="space-y-4 md:space-y-6">
                  <h1 className="text-3xl md:text-6xl font-bold bg-gradient-to-r from-red-200 via-orange-200 to-yellow-200 bg-clip-text text-transparent leading-tight">
                    {project.title}
                  </h1>
                  <div className="relative h-1 w-16 md:w-24">
                    <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-orange-500 rounded-full animate-pulse" />
                    <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-orange-500 rounded-full blur-sm" />
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-3 md:gap-4">
                  <a
                    ...
                    className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-gradient-to-r from-red-600/10 to-orange-600/10 hover:from-red-600/20 hover:to-orange-600/20 text-red-300 rounded-xl transition-all duration-300 border border-red-500/20 hover:border-red-500/40 backdrop-blur-xl overflow-hidden text-sm md:text-base"
                  >
                    <div className="absolute inset-0 translate-y-[100%] bg-gradient-to-r from-red-600/10 to-orange-600/10 transition-transform duration-300 group-hover:translate-y-[0%]" />
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-gradient-to-r from-orange-600/10 to-yellow-600/10 hover:from-orange-600/20 hover:to-yellow-600/20 text-orange-300 rounded-xl transition-all duration-300 border border-orange-500/20 hover:border-orange-500/40 backdrop-blur-xl overflow-hidden text-sm md:text-base"
                    onClick={(e) =>
                      !handleGithubClick(project.github) && e.preventDefault()
                    }
                  >
                    <div className="absolute inset-0 translate-y-[100%] bg-gradient-to-r from-orange-600/10 to-yellow-600/10 transition-transform duration-300 group-hover:translate-y-[0%]" />
                  ...
                  {project.figma && (
                    ...
                    >
                      ...
                      <span className="relative font-medium">Figma</span>
                    </a>
                  )}
                </div>
